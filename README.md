...
- **Control over dispatch work.** Configurable queue limits and per-pass budgets
  ...
  Enhanced Input behaviors. The separate [benchmark methodology](benchmarks/runner/README.md)
  compares complete input paths and explains the limits of performance evidence.
...
configurable rate. The sample benchmark uses 50 passes/sec. See
