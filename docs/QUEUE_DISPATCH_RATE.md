...
increase event latency or cause explicit rejections. Gameplay performance has not
been established by the low-rate sample alone; fewer checks do not prove lower
frame times. Test the new limits under the intended workload before deployment.
